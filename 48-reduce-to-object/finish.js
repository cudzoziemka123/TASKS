...
const quantitiesByCategories = (products) => {
  return products.reduce((newObj, product) => 
  {
    // if(newObj[product.category]) {
    //   newObj[product.category] = product.quantity + newObj[product.category]
    //   return newObj
    // }
    // newObj[product.category] = product.quantity 
    // return newObj
    
    newObj[product.category] = product.quantity + (newObj[product.category] || 0)
    return newObj
  }, 
{})
}
